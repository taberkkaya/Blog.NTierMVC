            ...
            modelBuilder.Entity("Blog.NTierMVC.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "890e8798-ef3b-40fa-9408-37999da5d84f",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "89739166-f9fc-4ae3-8eb2-1ee39f92afc1",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "93a81bf8-7acc-46bd-a666-001ab79440a3",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.NTierMVC.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3df6a898-dbb2-40e1-8f2a-ee1f73e2139e",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIvb9eRVG4Csk0xNv/EcqQD/nsc3jAtMQ9rWc1YSzIpOWxb+YpsmaijPv2dMcXjNXQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8425b720-26ac-4153-b707-f9d3d63c0370",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFbdVR5NP3A8OvMd/MKcfS4L8GjHwuyeyeR4cHqiO4Xv0giriLLI6HtvlrRyiPfcoA==",
            ...
            modelBuilder.Entity("Blog.NTierMVC.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76ca4c8a-45e6-45ef-be86-16d1beffd129"),
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 4, 20, 0, 27, 51, 283, DateTimeKind.Local).AddTicks(1282),
                        ...
                        new
                        {
                            Id = new Guid("115ceecf-1810-460b-889e-ec6b76f4997b"),
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 4, 20, 0, 27, 51, 283, DateTimeKind.Local).AddTicks(1290),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageId = new Guid("cd6083ab-faa6-4a2c-bffa-1c01c46a7b71"),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Blog.NTierMVC.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 4, 20, 0, 27, 51, 283, DateTimeKind.Local).AddTicks(2417),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 4, 20, 0, 27, 51, 283, DateTimeKind.Local).AddTicks(2421),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Blog.NTierMVC.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 4, 20, 0, 27, 51, 283, DateTimeKind.Local).AddTicks(3250),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FileName = "Test",
                            FileType = "jpg",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 4, 20, 0, 27, 51, 283, DateTimeKind.Local).AddTicks(3253),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
